...
console.log(createMenuItem("lasagna", 20, "dinner"))
console.log(createMenuItem("salad", 8, "breakfast"))
...
reviews.push({name: "Jimmy", rating: "4", feedback: "wowowowowowowowowowowow"})
